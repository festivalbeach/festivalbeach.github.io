    ...
    return (
      <div>
        ...
        <Modal scrollable isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader style={
            {backgroundColor: ((this.props.plantInfoProp['Bloom Color'] == "" || this.props.plantInfoProp['Bloom Color'] == "White") ? "lightblue" : this.props.plantInfoProp['Bloom Color'])}} 
            toggle={this.toggle}>{this.props.plant}
          </ModalHeader>
          <ModalBody>
              Name: {this.props.plantInfoProp['Label']} <br />
              Taxonomy: {this.props.plantInfoProp['Family']} {this.props.plantInfoProp['Genus']} {this.props.plantInfoProp['Species']}<br />
          ...
          <ModalFooter style={{backgroundColor: ((this.props.plantInfoProp['Bloom Color'] == "" || this.props.plantInfoProp['Bloom Color'] == "White") ? "lightblue" : this.props.plantInfoProp['Bloom Color'])}}>
